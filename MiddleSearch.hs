...
findRealBestMiddleMove :: Colour -> AllPieces -> (Piece, Move, Float)
findRealBestMiddleMove c ps = findStrongestMoveFromAll [ addTrueEval (c,c) 0 x ps | x <- takeTopMoves 0 (makeEvalList c ps)]
